 ...
 */
public class footerAdmin extends TagSupport {
    @Override
    public int doStartTag() throws JspException {
        try {
            ...
            pageContext.getOut().print( "<form method=\"post\" action=\"/adminMenu\">" );
            pageContext.getOut().print( "<input style=\"height:100%; width:100%\" type=\"submit\" value=\"Меню администратора\">" );
